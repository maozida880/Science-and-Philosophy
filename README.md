...
├── feature/
│   ├── predict/
│   │   └── ads_purchase_user_predict.sql
│   └── train/
│       ├── ads_purchase_pc_plan_feature.sql
│       ├── ads_purchase_user_feature.sql
│       ├── dim_purchase_plan_goods.sql
│       ├── dwd_purchase_order_goods_deduct_detail.sql
│       ├── dwd_purchase_order_goods_refund_detail.sql
│       ├── dwd_purchase_order_goods_use_detail.sql
│       ├── dwm_purchase_plan_detail.sql
│       ├── dwm_purchase_plan_goods_detail.sql
│       └── dwm_purchase_user_detail.sql
├── python/
│   ├── predict/
...
#### 1\. 部署到 10.10.208.55 服务器 (ssh\_conn\_id='ssh\_208\_55')

请将以下文件部署到 `10.10.208.55` 服务器的对应路径：
  ...
  - `sys/55/feature/predict/ads_purchase_user_predict.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/predict/ads_purchase_user_predict.sql`

  - `sys/55/feature/train/ads_purchase_pc_plan_feature.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/ads_purchase_pc_plan_feature.sql`

  - `sys/55/feature/train/ads_purchase_user_feature.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/ads_purchase_user_feature.sql`

  - `sys/55/feature/train/dim_purchase_plan_goods.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dim_purchase_plan_goods.sql`

  - `sys/55/feature/train/dwd_purchase_order_goods_deduct_detail.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dwd_purchase_order_goods_deduct_detail.sql`

  - `sys/55/feature/train/dwd_purchase_order_goods_refund_detail.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dwd_purchase_order_goods_refund_detail.sql`

  - `sys/55/feature/train/dwd_purchase_order_goods_use_detail.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dwd_purchase_order_goods_use_detail.sql`

  - `sys/55/feature/train/dwm_purchase_plan_detail.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dwm_purchase_plan_detail.sql`

  - `sys/55/feature/train/dwm_purchase_plan_goods_detail.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dwm_purchase_plan_goods_detail.sql`

  - `sys/55/feature/train/dwm_purchase_user_detail.sql`
    \-\> `/opt/bdp/project/bdp_rights_coupon_rec_project/feature/train/dwm_purchase_user_detail.sql`

#### 2\. 部署到 10.10.209.133 服务器 (ssh\_conn\_id='ssh\_model\_133')

请将以下文件部署到 `10.10.209.133` 服务器的对应路径：
...
在Airflow DAG**首次运行前**，请在 `10.10.208.55` 服务器上手动执行以下SQL文件，以确保HBase和Hive中的目标表已创建：
